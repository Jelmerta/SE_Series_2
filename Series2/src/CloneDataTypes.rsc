...
data Duplication = duplication(str filePath, list[int] lines, list[str] code);
...
data CloneClass = cloneClass(str cloneClassName, int amountOfDuplications, int treeSize, int amountOfLines, list[Duplication] duplications); // Each clone class contains two or more duplications
